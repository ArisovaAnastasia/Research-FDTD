...
void Initializing_Sigma_Coeff_sycl_half_version_2_0(Coefficient<ftype_init>& Coeff, Sigma<ftype_sigma>& Sigma, int Nx, int Ny, int Nz,
	...
	ofstream numb_sgm("sigma_new.txt"), numb_coef("coeff_new.txt");


	ftype_sigma sigmaEx, sigmaEy, sigmaEz, sigmaBx, sigmaBy, sigmaBz;

	float Exy1, Exz1, Ezx1, Ezy1, Eyx1, Eyz1;
	float Bxy1, Bxz1, Bzx1, Bzy1, Byx1, Byz1;
...
inline void Update_electric_field_PML_sycl_half_version(Fields<ftype> cube,
